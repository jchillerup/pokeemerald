...
static const u8 sUnusedText_Terminating[] = _("Afslutter.");
static const u8 sUnusedText_LinkPartnerNotFound[] = _("Linkpartner(e) ikke fundet.\nPrøv venligst igen.\p");

static const u8 sText_BerryBlenderStart[] = _("Starter BÆRBLÆNDEREN.\pVælg venligst et BÆR fra din TASKE\nfor at putte i BÆRBLÆNDEREN.\p");
static const u8 sText_NewParagraph[] = _("\p");
static const u8 sText_WasMade[] = _(" blev lavet!");
static const u8 sText_Mister[] = _("HR.");
static const u8 sText_Laddie[] = _("VEN");
static const u8 sText_Lassie[] = _("VENINDE");
static const u8 sText_Master[] = _("MESTER");
static const u8 sText_Dude[] = _("FYR");
static const u8 sText_Miss[] = _("FRØKEN");
...
static const u8 sText_PressAToStart[] = _("Tryk på knappen A for at starte.");
static const u8 sText_PleaseWaitAWhile[] = _("Vent venligst et øjeblik.");
static const u8 sText_CommunicationStandby[] = _("Kommunikation standby…");
static const u8 sText_WouldLikeToBlendAnotherBerry[] = _("Vil du blande endnu en BÆR?");
static const u8 sText_RunOutOfBerriesForBlending[] = _("Du er løbet tør for BÆR til at blande i BÆRBLÆNDEREN.\p");
static const u8 sText_YourPokeblockCaseIsFull[] = _("Din {POKEBLOCK} TASKE er fuld.\p");
static const u8 sText_HasNoBerriesToPut[] = _(" har ingen BÆR at putte i\nBÆRBLÆNDEREN.");
static const u8 sText_ApostropheSPokeblockCaseIsFull[] = _("'s {POKEBLOCK} TASKE er fuld.\p");
static const u8 sText_BlendingResults[] = _("RESULTATER AF BLANDINGEN");
static const u8 sText_BerryUsed[] = _("BÆR BRUGT");
static const u8 sText_SpaceBerry[] = _(" BÆR");
static const u8 sText_Time[] = _("Tid:");
static const u8 sText_Min[] = _(" min. ");
static const u8 sText_Sec[] = _(" sek.");
static const u8 sText_MaximumSpeed[] = _("MAKSIMAL HASTIGHED");
static const u8 sText_RPM[] = _(" RPM");
static const u8 sText_Dot[] = _(".");
static const u8 sText_NewLine[] = _("\n");
static const u8 sText_Space[] = _(" ");
static const u8 sText_Ranking[] = _("PLACERING");
static const u8 sText_TheLevelIs[] = _("Niveauet er ");
static const u8 sText_TheFeelIs[] = _(", og fornemmelsen er ");
