...
static const u8 sText_IsThisTradeOkay[] = _("Er dette byt okay?");
static const u8 sText_Cancel[] = _("AFBRYD");
static const u8 sText_ChooseAPkmn[] = _("Vælg en POKéMON.");
static const u8 sText_Summary[] = _("OVERSIGT");
